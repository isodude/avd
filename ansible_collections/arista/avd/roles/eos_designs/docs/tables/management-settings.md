...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;source_address_family</samp>](## "ntp_settings.servers.[].source_address_family") | String |  | `ipv4` |  | Valid Values:<br>- <code>ipv4</code><br>- <code>ipv6</code> | Source IP address family. |
    ...
    ntp_settings:
      ...
      servers:
        ...
        - name: <str>
          ...
          source_address_family: <str; "ipv4" | "ipv6">
