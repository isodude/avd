...
### Fixed issues in eos_designs and eos_cli_config_gen
- Fix(eos_cli_config_gen, eos_designs): Add source_address under ntp_settings @isodude in https://github.com/aristanetworks/avd/pull/5744
...
- All tests will be removed from the catalog for a device flagged as undeployed using the host level variable [`is_deployed: false`](https://avd.arista.com/stable/ansible_collections/arista/avd/roles/eos_designs/docs/input-variables.html#flagging-a-device-as-not-deployed).
...
- Inband management reachability test has been refactored to support AVD inband management [data model](https://avd.arista.com/stable/ansible_collections/arista/avd/roles/eos_designs/docs/input-variables.html#node-type-inband-management).
